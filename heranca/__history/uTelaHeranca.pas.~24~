...
begin
  TermoPesquisa := AnsiLowerCase(TMaskEdit(Sender).Text); // Converte para minúsculas

  // Utiliza a função Locate com loCaseInsensitive para tornar a pesquisa insensível a maiúsculas e minúsculas
